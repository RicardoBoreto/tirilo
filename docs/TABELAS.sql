...
CREATE TABLE IF NOT EXISTS public.saas_clinicas (
...
CREATE TABLE IF NOT EXISTS public.clinicas_salas (
    id SERIAL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS public.terapeutas_curriculo (
    id BIGINT PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE IF NOT EXISTS public.pacientes_anamnese (
    id SERIAL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS public.pacientes_terapeutas (
    paciente_id INTEGER REFERENCES public.pacientes(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS public.saas_habilidades (
...
CREATE TABLE IF NOT EXISTS public.saas_jogos (
    id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
    nome TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.saas_jogos_habilidades (
...
CREATE TABLE IF NOT EXISTS public.saas_jogos_versoes (
    id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
    jogo_id UUID REFERENCES public.saas_jogos(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS public.saas_clinicas_jogos (
    id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
...
-- Frota de Robôs
CREATE TABLE IF NOT EXISTS public.saas_frota_robos (
    id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS public.clinica_config_ia (
...
CREATE TABLE IF NOT EXISTS public.saas_diretrizes_ai (
    id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS public.sessao_ludica (
    id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS public.sessao_diario_bordo (
    id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS public.sessao_telemetria (
    id BIGINT PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
    mac_address TEXT,
    jogo TEXT,
    resultado TEXT,
...
CREATE TABLE IF NOT EXISTS public.comandos_robo (
    id BIGINT PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
    mac_address TEXT,
...
CREATE TABLE IF NOT EXISTS public.planos_intervencao_ia (
    id BIGINT PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
    id_paciente BIGINT REFERENCES public.pacientes(id),
    id_terapeuta UUID REFERENCES public.usuarios(id),
...
CREATE TABLE IF NOT EXISTS public.saas_manutencoes_frota (
    id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS public.salas_recursos (
    id BIGINT PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
    id_clinica BIGINT REFERENCES public.saas_clinicas(id),
    nome TEXT NOT NULL,
    descricao TEXT,
...
CREATE TABLE IF NOT EXISTS public.help_desk_mensagens (
    id BIGINT PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
