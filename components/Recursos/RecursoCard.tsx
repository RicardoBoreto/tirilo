...
export default function RecursoCard({ recurso }: RecursoCardProps) {
    ...
    return (
        <>
            <div className="bg-white dark:bg-gray-800 rounded-3xl p-4 shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-md transition-all group flex flex-col h-full">
