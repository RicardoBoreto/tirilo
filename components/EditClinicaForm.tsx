...
export default function EditClinicaForm({ clinica }: { clinica: Clinica }) {
    ...
    const [formData, setFormData] = useState({
        ...
        missao: clinica.missao || '',
        end_cep: clinica.end_cep || '',
        end_logradouro: clinica.end_logradouro || '',
        end_numero: clinica.end_numero || '',
        end_complemento: clinica.end_complemento || '',
        end_bairro: clinica.end_bairro || '',
        end_cidade: clinica.end_cidade || '',
        end_estado: clinica.end_estado || '',
