...
HAAR_PATH = os.path.join(DIR_BASE, "haarcascades", "haarcascade_frontalface_default.xml")
...
def inicializar_hardware():
    ...
    try:
        ...
        print(f"Erro ao ligar motores (PCA): {e}")
        HARDWARE_ATIVO = False
